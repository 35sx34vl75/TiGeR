...
local function pre_process(msg)
	...
	if not redis:get(RedisIndex.."TiGeRLikes") then redis:set(RedisIndex.."TiGeRLikes",0) end
	if not redis:get(RedisIndex.."TiGeRDisLikes") then redis:set(RedisIndex.."TiGeRDisLikes",0) end
