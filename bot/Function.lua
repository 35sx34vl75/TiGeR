...
function chat_list(msg)
	...
	local StartPm = {"↫ ","⇜ ","⌯ ","℘ ","↜ ","⇋ "}
	local M_START = StartPm[math.random(#StartPm)]
	local message = M_START..'لیست گروه های ربات تایکر:\n\n'
	if #list == 0 then
...
function group_settings(msg)
	...
	local gif = (mute_gif == "Warn") and "اخطار" or ((mute_gif == "Kick") and "اخراج" or ((mute_gif == "Mute") and "سکوت" or ((mute_gif == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local photo = (mute_photo == "Warn") and "اخطار" or ((mute_photo == "Kick") and "اخراج" or ((mute_photo == "Mute") and "سکوت" or ((mute_photo == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local sticker = (mute_sticker == "Warn") and "اخطار" or ((mute_sticker == "Kick") and "اخراج" or ((mute_sticker == "Mute") and "سکوت" or ((mute_sticker == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local contact = (mute_contact == "Warn") and "اخطار" or ((mute_contact == "Kick") and "اخراج" or ((mute_contact == "Mute") and "سکوت" or ((mute_contact == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local inline = (mute_inline == "Warn") and "اخطار" or ((mute_inline == "Kick") and "اخراج" or ((mute_inline == "Mute") and "سکوت" or ((mute_inline == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local game = (mute_game == "Warn") and "اخطار" or ((mute_game == "Kick") and "اخراج" or ((mute_game == "Mute") and "سکوت" or ((mute_game == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local textt = (mute_text == "Warn") and "اخطار" or ((mute_text == "Kick") and "اخراج" or ((mute_text == "Mute") and "سکوت" or ((mute_text == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local keyboard = (mute_keyboard == "Warn") and "اخطار" or ((mute_keyboard == "Kick") and "اخراج" or ((mute_keyboard == "Mute") and "سکوت" or ((mute_keyboard == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local forward = (mute_forward == "Warn") and "اخطار" or ((mute_forward == "Kick") and "اخراج" or ((mute_forward == "Mute") and "سکوت" or ((mute_forward == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local views = (lock_views == "Warn") and "اخطار" or ((lock_views == "Kick") and "اخراج" or ((lock_views == "Mute") and "سکوت" or ((lock_views == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local location = (mute_location == "Warn") and "اخطار" or ((mute_location == "Kick") and "اخراج" or ((mute_location == "Mute") and "سکوت" or ((mute_location == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local document = (mute_document == "Warn") and "اخطار" or ((mute_document == "Kick") and "اخراج" or ((mute_document == "Mute") and "سکوت" or ((mute_document == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local voice = (mute_voice == "Warn") and "اخطار" or ((mute_voice == "Kick") and "اخراج" or ((mute_voice == "Mute") and "سکوت" or ((mute_voice == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local audio = (mute_audio == "Warn") and "اخطار" or ((mute_audio == "Kick") and "اخراج" or ((mute_audio == "Mute") and "سکوت" or ((mute_audio == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local video = (mute_video == "Warn") and "اخطار" or ((mute_video == "Kick") and "اخراج" or ((mute_video == "Mute") and "سکوت" or ((mute_video == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local video_note = (mute_video_note == "Warn") and "اخطار" or ((mute_video_note == "Kick") and "اخراج" or ((mute_video_note == "Mute") and "سکوت" or ((mute_video_note == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local link = (lock_link == "Warn") and "اخطار" or ((lock_link == "Kick") and "اخراج" or ((lock_link == "Mute") and "سکوت" or ((lock_link == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local tag = (lock_tag == "Warn") and "اخطار" or ((lock_tag == "Kick") and "اخراج" or ((lock_tag == "Mute") and "سکوت" or ((lock_tag == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local username = (lock_username == "Warn") and "اخطار" or ((lock_username == "Kick") and "اخراج" or ((lock_username == "Mute") and "سکوت" or ((lock_username == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local arabic = (lock_arabic == "Warn") and "اخطار" or ((lock_arabic == "Kick") and "اخراج" or ((lock_arabic == "Mute") and "سکوت" or ((lock_arabic == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local mention = (lock_mention == "Warn") and "اخطار" or ((lock_mention == "Kick") and "اخراج" or ((lock_mention == "Mute") and "سکوت" or ((lock_mention == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local edit = (lock_edit == "Warn") and "اخطار" or ((lock_edit == "Kick") and "اخراج" or ((lock_edit == "Mute") and "سکوت" or ((lock_edit == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local markdown = (lock_markdown == "Warn") and "اخطار" or ((lock_markdown == "Kick") and "اخراج" or ((lock_markdown == "Mute") and "سکوت" or ((lock_markdown == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local webpage = (lock_webpage == "Warn") and "اخطار" or ((lock_webpage == "Kick") and "اخراج" or ((lock_webpage == "Mute") and "سکوت" or ((lock_webpage == "Enable") and "TiGeRLock" or "TiGeRUnlock")))
	local bots =  (lock_bots == "Enable" and "MaTaDoRLock" or "MaTaDoRUnlock")
	local all =  (mute_all == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local tgservice =  (mute_tgservice == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local join =  (lock_join == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local pin =  (lock_pin == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local spam =  (lock_spam == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local flood =  (lock_flood == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local welcome = (lock_welcome == "Enable" and "TiGeRLock" or "TiGeRUnlock")
	local expire_date = ''
	local expi = redis:ttl(RedisIndex..'ExpireDate:'..msg.to.id)
	if expi == -1 then
		expire_date = 'نامحدود!'
	...
	text = string.gsub(text, 'TiGeRUnlock', "غیرفعال")
	text = string.gsub(text, 'TiGeRLock', "فعال")
...
if not mr_roo and msg.reply_id then
		...
		}, action_by_reply, {chat_id=msg.to.id,cmd=tiger})
	end
	if mr_roo and string.match(mr_roo, '^%d+$') then
		tdbot_function ({
		_ = "getUser",
		user_id = mr_roo,
		}, action_by_id, {chat_id=msg.to.id,user_id=mr_roo,cmd=tiger})
	end
	if mr_roo and not string.match(mr_roo, '^%d+$') then
		tdbot_function ({
		_ = "searchPublicChat",
		username = mr_roo
		}, action_by_username, {chat_id=msg.to.id,username=mr_roo,cmd=tiger})
	end
end
