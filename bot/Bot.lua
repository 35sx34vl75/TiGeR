...
function create_config( )
	...
	sudo_users = {521307846,SUDO,BotTiGeR_id,BotTiGeR_idapi},
	admins = {},
	disabled_channels = {},
...
function is_JoinChannel(msg)
	...
	if (not Joinchanel.ok or Joinchanel.result.status == "left" or Joinchanel.result.status == "kicked") and not is_sudo(msg) and not joinenabel then
		...
		tdbot.getInlineQueryResults(BotTiGeR_idapi, msg.chat_id, 0, 0, "Join", 0, inline_query_cb, nil)
	else
		return true
	end
end
